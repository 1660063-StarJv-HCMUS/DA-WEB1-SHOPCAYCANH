                ...
                <div class="col-md-6">
                    <div class="billing-details">
                        ...
                        <div class="form-group">
                            <input class="input" type="text" name="first-name" placeholder="Trần Hữu Dũng" disabled>
                        </div>
                        <div class="form-group">
                            <input class="input" type="email" name="email" placeholder="Tranhuudung1@gmail.com"
                                disabled>
                        </div>
                        <div class="form-group">
