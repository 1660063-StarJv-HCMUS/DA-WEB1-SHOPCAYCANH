<div class="dropdown themmoi">
    ...
    <form action="http://localhost:8080/web1/DA-WEB1-SHOPCAYCANH/admin/BUS/HangSanPham/Them.php" id="form-them-hang-san-pham" method="post" name="main-form" id="main-form" enctype="multipart/form-data" accept-charset="utf-8" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
